-- PhotoMapperAI - SQL Server Example Query
-- Extracts player data for photo mapping from SQL Server database
-- Usage: photomapperai extract -inputSqlPath sql-server-players.sql -teamId 10 -outputName team.csv
